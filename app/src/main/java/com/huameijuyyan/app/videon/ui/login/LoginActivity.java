package com.huameijuyyan.app.videon.ui.login;
...
import com.huameijuyyan.app.util.helper.ActivityTracker;
...
import com.huameijuyyan.app.databinding.ActivityLoginBinding;
import com.huameijuyyan.app.videon.ui.forgotpassword.ForgotPasswordActivity;
import com.huameijuyyan.app.videon.ui.home.HomeActivity;
import com.huameijuyyan.app.videon.ui.signup.SignUpActivity;
...
public class LoginActivity extends BaseActivity {
    ...
    public void checkFacebookSignIn() {
        if (!mBinding.coreFacebookLoginBtn.getText().toString().toLowerCase(Locale.ROOT).equals("log out")) {
...
//                                Snackbar.make(getWindow().getDecorView(), models.getMessage(), Snackbar.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.text_sign_up_message) {
            ...
            mainSignIn(mBinding.editTextEmail.getText().toString().trim(),
            ...
            if (SharedPref.readBoolean(PrefType.AUTH_STATUS) == PrefType.STATUS_SUCCESS
                    && (SharedPref.read(PrefType.AUTH_TYPE).equals(PrefType.GOOGLE_AUTH))) {
                revokeAccess();
                LoginManager.getInstance().logOut();
                SharedPref.clear();

package com.huameijuyyan.app.videon.data.remote.home;
...
import com.huameijuyyan.app.videon.ui.videodetails.ViewCountResponse;
...
public interface RemoteVideoApiInterface {
    ...
    Call<Datum> getRecentVideo(@Field("api_token") String api_token, @Field("page") int pageNo);
    /**
     * Request to server for the recent video list
     * */
    @FormUrlEncoded
     ...
     */
    @FormUrlEncoded
    @POST("public/api/review/by-item.php")

package com.huameijuyyan.app.videon.data.local.commondatalistresponse;
...
public class Datum {
    ...
    public void setTotalPageNO(int total) {
    ...
    public static DiffUtil.ItemCallback<Datum> callback = new DiffUtil.ItemCallback<Datum>() {
        @Override
        public boolean areItemsTheSame(@NonNull Datum datum, @NonNull Datum t1) {
            return datum.getId().equals(t1.getId());
        }

        @Override
        public boolean areContentsTheSame(@NonNull Datum datum, @NonNull Datum t1) {
            return datum.equals(t1);
        }
    };
}
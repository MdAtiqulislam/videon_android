...
import com.huameijuyyan.app.util.DeveloperKey;
import com.huameijuyyan.app.util.helper.AdHelper;
import com.huameijuyyan.app.util.helper.ApiToken;
import com.huameijuyyan.app.util.helper.AppConstants;
import com.huameijuyyan.app.util.helper.AppDownloadManager;
import com.huameijuyyan.app.util.helper.BarUtil;
import com.huameijuyyan.app.util.helper.CmdDownload;
import com.huameijuyyan.app.util.helper.DialogHelper;
import com.huameijuyyan.app.util.helper.PermissionUtil;
...
import com.huameijuyyan.app.videon.data.local.authentication.AuthenticationModel;
...
import com.huameijuyyan.app.videon.data.local.commondatalistresponse.VideoDetailsByIdResponseModel;
import com.huameijuyyan.app.videon.data.local.downloadsetting.DownloadSetting;
import com.huameijuyyan.app.videon.data.local.downloadsetting.DownloadSettingResponse;
import com.huameijuyyan.app.videon.data.local.userstatus.Data;
import com.huameijuyyan.app.videon.data.local.userstatus.UserStatus;
...
import com.huameijuyyan.app.databinding.ActivityVideoDetailsBinding;
import com.huameijuyyan.app.videon.ui.adapter.CommonDataAdapter;
import com.huameijuyyan.app.videon.ui.empty.EmptyActivity;
import com.huameijuyyan.app.videon.ui.fullscreenactivity.FullScreeActivity;
import com.huameijuyyan.app.videon.ui.home.MyMediaController;
import com.huameijuyyan.app.videon.ui.home.UICommunicator;
import com.google.android.exoplayer2.DefaultRenderersFactory;
import com.google.android.exoplayer2.PlaybackException;
import com.google.android.exoplayer2.source.ProgressiveMediaSource;

import com.huameijuyyan.app.videon.ui.reviewdetails.ReviewDetailsActivity;
...
public class VideoDetailsActivity extends BaseActivity implements ItemClickListener<Datum>, YouTubePlayer.OnInitializedListener, YouTubePlayer.PlaybackEventListener,
    ...
    protected void startUI() {
        ...
        setClickListener(mBinding.overlayItem, mBinding.constraintLayer, mBinding.exoPlayerView, mBinding.maxMin, mBinding.forward, mBinding.backword,
                ...
                mBinding.imageViewFav, mBinding.textViewRateThis, mBinding.imageViewVideoDetailsBack, mBinding.constraintLayer, mBinding.contentPanel, mBinding.textViewSeeAllReview);
    ...
    private void initializeExoPlayerAndPlayVideo(String videoLink) {
        ...
        if (player == null) {
            ...
            player = new SimpleExoPlayer.Builder(this, renderFactory).build();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                MediaItem mediaItem = MediaItem.fromUri(Uri.parse(videoLink));
...
/*    private void loadVimoVideo(String vid_id) {
        if (exo_player_view.getVisibility() == View.GONE) {
        ...
        VimeoExtractor.getInstance().fetchVideoWithIdentifier(vid_id, null, new OnVimeoExtractionListener() {
            @Override
            public void onSuccess(VimeoVideo video) {
                String stream360 = video.getStreams().get("360p");
                if (stream360 != null) {
                    playExoPlayer(stream360);
                } else {
                    loadVimeoWebView(vid_id);
                }
            }

            @Override
            public void onFailure(Throwable throwable) {
                // যদি exception "Video has restricted playback" হয়
                loadVimeoWebView(vid_id);
            }
        });
    }*/
    ...
    private void loadVimoVideo(String vid_id) {
        ...
        System.out.println("VID ID: " + vid_id);
        ...
        VimeoExtractor.getInstance().fetchVideoWithIdentifier(vid_id, null, new OnVimeoExtractionListener() {
            ...
            public void onSuccess(VimeoVideo video) {
                ...
                String hdStream = streams.get("360p"); // check available keys

                System.out.println("VIMEO VIDEO STREAM: " + hdStream);

                if (hdStream != null) {
                    runOnUiThread(() -> loadOtherVideo(hdStream));
                } else {
                    System.out.println("360p stream not found!");
                }
            }
            ...
            public void onFailure(Throwable throwable) {
                ...
                Log.e("VimeoExtractor", "Failed to extract video");
            }
        });
    }
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        this.youTubePlayer.loadVideo(url);
...
//        youTubePlayer.setFullscreen(true);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.content_panel || id == R.id.constraint_layer || id == R.id.overlay_item) {
            controller_hide_visible();
        } else if (id == R.id.max_min) {
            maximize();
        } else if (id == R.id.forward) {
            firstforward(view);
        } else if (id == R.id.backword) {
            backward(view);
        } else if (id == R.id.play_pause) {
            play_pause();
        } else if (id == R.id.text_view_rate_this) {
            if (!userid.equals("")) {
        ...
        } else if (id == R.id.image_view_fav) {
            if (!userid.equals("")) {
                favSelection();
            } else {
                checkLogin();
        ...
        } else if (id == R.id.image_view_play_list) {
            if (!userid.equals("")) {
                addToPlayList();
            } else {
                checkLogin();
        ...
        } else if (id == R.id.image_view_video_details_back) {
            if (savedInstanceState != null) {
                if (savedInstanceState.getBoolean(PrefType.ORIENTATION_MODE) == PrefType.LANDSCAPE) {
                    maximize();
                } else {
        ...
        } else if (id == R.id.text_view_see_all_review) {
            ReviewDetailsActivity.runActivity(this, videoId, 1);
        }
    }
    ...
    /*public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.text_view_see_all_review:
                ReviewDetailsActivity.runActivity(this, videoId, 1);
                break;
        }
    }*/
    ...
    public void initialte_video_details_contents() {
        ...
        mBinding.textViewViewsUploadTime.setText("" + model.getCreated());
    }
    ...
    public void executeAction(String selectedButton) {
        ...
        if (model.getType() == Enums.VIMEO_VIDEO) {
            ...
            AppDownloadManager.download(vimeoVideo.getStreams().get(ytLink.toLowerCase(Locale.ROOT)), vimeoVideo.getTitle(), vimeoVideo.getTitle() + ".mp4", VideoDetailsActivity.this);
    ...
    private String formatTime(int millis) {
        ...
        return (hours == 0 ? "00:" : hours + ":") + String.format(Locale.ROOT, "%02d:%02d", minutes % 60, seconds % 60);
    }

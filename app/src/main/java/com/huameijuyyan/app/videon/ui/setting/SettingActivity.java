package com.huameijuyyan.app.videon.ui.setting;
...
import com.huameijuyyan.app.util.helper.CopyDataHelper;
...
import com.huameijuyyan.app.databinding.ActivitySettingBinding;
import com.huameijuyyan.app.videon.ui.aboutus.AboutUsActivity;
import com.huameijuyyan.app.videon.ui.empty.EmptyActivity;
import com.huameijuyyan.app.videon.ui.login.LoginActivity;
import com.huameijuyyan.app.videon.ui.privacypolicy.PrivacyPolicyActivity;
...
public class SettingActivity extends BaseActivity implements MySessionManager.CallBackListener {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (isNotFirstOpen) {
                    if (position == 0) {
                        ...
                        saveSharedPref(SharedPref.LAN, Enums.ARABIC);
                        Toast.makeText(SettingActivity.this, getResources().getString(R.string.language_change_notification), Toast.LENGTH_LONG);
                        updateViews();
                    }
                } else {
    ...
    private void checkLoginStateAndChangeText() {
        if (SharedPref.read(PrefType.USER_REGID).equals("")) {
            ...
            mBinding.textViewLogout.setText(getResources().getString(R.string.setting_sign_in));
        } else {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.constraint_layout_about_us_section) {
            AboutUsActivity.runActivity(this);
        }
        else if (id == R.id.constraint_layout_privacy_policy_section) {
            PrivacyPolicyActivity.runActivity(this);
        }
        else if (id == R.id.constraint_layout_logout_section) {
            if (!SharedPref.read(PrefType.USER_REGID).equals("")) {
                // login state
                alertDialog();
            } else {

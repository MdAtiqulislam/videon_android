...
import com.huameijuyyan.app.databinding.ItemLiveTvBinding;
import com.huameijuyyan.app.databinding.ItemMostRecentVideoBinding;
        ...
        public void bind(Datum item) {
            ...
            if(isRecent)
            {
                ...
                if(item.getCategory()!=null) {
                    ...
                    mItemLiveTvBinding.textViewLiveTvTitle.setGravity(Gravity.START); //to ensure correct behavior in right-to-left locales

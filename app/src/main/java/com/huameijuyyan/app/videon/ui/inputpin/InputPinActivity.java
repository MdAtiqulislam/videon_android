package com.huameijuyyan.app.videon.ui.inputpin;
...
import com.huameijuyyan.app.databinding.ActivityInputPinBinding;
import com.huameijuyyan.app.videon.ui.createnewpassword.CreateNewPasswordActivity;
import com.huameijuyyan.app.videon.ui.videodetails.ViewCountResponse;
import com.huameijuyyan.app.videon.ui.welcome.WelcomeActivity;
    ...
    private void timeCountDownStart(){
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                String second = String.format(Locale.ROOT,"%02d", TimeUnit.MILLISECONDS.toSeconds(millis) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(millis)));

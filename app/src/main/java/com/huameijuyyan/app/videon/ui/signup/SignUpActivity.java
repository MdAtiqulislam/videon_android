package com.huameijuyyan.app.videon.ui.signup;
...
import com.huameijuyyan.app.databinding.ActivitySignupBinding;
import com.huameijuyyan.app.videon.ui.inputpin.InputPinActivity;
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.text_sign_in_message) {
            ...
            signUp(
                    Enums.EMAIL_LGOIN,
                    "",
                    mBinding.editName.getText().toString().trim(),
                    mBinding.editEmail.getText().toString().trim(),

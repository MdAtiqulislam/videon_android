package com.huameijuyyan.app.videon.ui.downloadmanager;
...
import com.huameijuyyan.app.util.helper.TimeUtil;
...
import com.huameijuyyan.app.databinding.ActivityDownloadManagerBinding;
import com.huameijuyyan.app.videon.ui.adapter.DownloadVideoAdapter;
...
public class DownloadManagerActivity extends BaseActivity implements DownloadVideoAdapter.OnDownloadClick, DialogHelper.InputDialogListener {
    ...
    public int getLinkType(String link) {
        if (link.toLowerCase(Locale.ROOT).contains("vimeo.com")) {
            return Enums.VIMEO_VIDEO;
        } else if (link.toLowerCase(Locale.ROOT).contains("youtube.com") || link.toLowerCase(Locale.ROOT).contains("youtu.be")) {
